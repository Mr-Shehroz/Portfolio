...
export default function Footer() {
    return (
        <footer className="bg-[#100425] lg:py-5 py-3">
            <Image className="md:w-[90%] w-[100%] mx-auto sm:h-[2px]" src="/footer-line.png" height={100} width={100} alt="Footer line" />
            <div className="2xl:max-w-7xl xl:max-w-[980px] lg:max-w-[850px] max-w-[630px] mx-auto flex items-center justify-between md:mt-6 mt-3 px-6">
