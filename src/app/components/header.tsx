    ...
    return (
        <div id='home' className='bg-[url("/bg-1.webp")] bg-cover bg-center bg-no-repeat h-screen'>
            <header className="sticky top-5 z-50">
                ...
                <section className='2xl:max-w-7xl xl:max-w-6xl lg:max-w-5xl max-w-2xl mx-auto flex flex-col md:flex-row items-center md:justify-between gap-20 md:gap-0 2xl:pt-50 lg:pt-30 pt-20 h-[85vh] px-6'>
