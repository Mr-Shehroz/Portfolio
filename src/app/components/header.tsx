        ...
        <div id='home' className='bg-[url("/bg-1.webp")] bg-cover bg-center bg-no-repeat h-screen'>
            <header className="sticky top-5 z-50">
                <div className={`2xl:max-w-7xl xl:max-w-6xl z-50 lg:max-w-5xl max-w-2xl mx-auto fixed lg:top-5 w-full left-0 right-0 flex items-center justify-between py-4 px-6 ${inter.className}`}>
                    ...
                    {/* Nav Menu */}
                    <nav className={`lg:flex ${menuOpen ? 'block absolute w-full left-0 right-0 top-16 bg-[#5B1F69] bg-opacity-80 rounded-lg p-4' : 'hidden'} 2xl:text-xl xl:text-[16px] lg:text-[14px] text-[10px]`}>
                ...
                <section className='2xl:max-w-7xl xl:max-w-6xl lg:max-w-5xl max-w-2xl mx-auto flex flex-col md:flex-row items-center justify-between 2xl:pt-50 lg:pt-30 pt-20 h-[85vh] px-6'>
